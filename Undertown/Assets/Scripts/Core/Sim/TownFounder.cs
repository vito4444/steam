...
namespace Undertown.Core.Sim
{
    ...
    public static class TownFounder
    {
        ...
        private static void FoundHiddenWorks(TownState town, int x, int y)
        {
            ...
            BuildingPlacement.Place(town, BuildingKind.HiddenEntrance, shaft, payCost: false);
            BuildingPlacement.Place(town, BuildingKind.Tunnel, new Coord(x + 1, y, 1), payCost: false);
            BuildingPlacement.Place(town, BuildingKind.Tunnel, new Coord(x + 2, y, 1), payCost: false);
            BuildingPlacement.Place(town, BuildingKind.Still, new Coord(x + 3, y, 1), payCost: false);
            BuildingPlacement.Place(town, BuildingKind.UnderStore, new Coord(x + 3, y + 1, 1), payCost: false);
